...
{
    public static async Task<string> GetAccessToken(IEnumerable<AuthenticationCredentialsProvider> credentials)
    {
    ...
    private static string GetJwtToken(IEnumerable<AuthenticationCredentialsProvider> credentials)
    {
        var technicalAccount = credentials.GetTechnicalAccount();
