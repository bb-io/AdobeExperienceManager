...
public class DownloadContentRequest : IDownloadContentInput
{
    ...
    [Display("Export only live copy's cancelled inheritance", Description = "Exports content for which inheritance is cancelled or there is no inheritance with parent.")]
